...
export function InventoryReceiptLegend() {
  const statuses: InventoryReceiptStatus[] = [
    "DRAFT",
    "AWAITING_IQC",
    "AWAITING_RECEIPT",
    "RECEIVED",
  ...
  return (
    <div className="grid grid-cols-1 gap-4 rounded-lg bg-card p-4 text-xs shadow-card sm:p-5 lg:grid-cols-2">
      ...
      {/* Tips */}
      <div className="space-y-2.5 border-t border-border/60 pt-3 lg:border-t-0 lg:border-l lg:pl-5 lg:pt-0">
        <div className="flex items-center gap-1.5 font-semibold text-foreground">
        ...
        <div className="space-y-1.5 text-muted-foreground">
          <p>
            • Nhấn icon xem chi tiết (mắt) để xem thông tin chi tiết phiếu nhập kho.
          </p>
          <p>
            • Chỉ phiếu ở trạng thái <strong className="text-foreground font-medium">Draft</strong> mới cho phép sửa hoặc xóa.
          </p>
          <p>
            • Đã hỗ trợ tính năng <strong className="text-foreground font-medium">In phiếu nhập kho</strong> trực tiếp từ danh sách và trang chi tiết.
          </p>
        </div>
      </div>
    </div>
