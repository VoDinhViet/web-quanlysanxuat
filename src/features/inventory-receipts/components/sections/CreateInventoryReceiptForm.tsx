...
import { CreateInventoryReceiptHeaderSection } from "@/features/inventory-receipts/components/sections/CreateInventoryReceiptHeaderSection"
import { CreateInventoryReceiptItemsSection } from "@/features/inventory-receipts/components/sections/CreateInventoryReceiptItemsSection"
...
export function CreateInventoryReceiptForm() {
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-lg bg-card shadow-card">
        <CreateInventoryReceiptHeaderSection form={form} disabled={isPending} />

        <div className="border-t border-border">
          <CreateInventoryReceiptItemsSection
            form={form}
            disabled={isPending}
          />
        </div>
