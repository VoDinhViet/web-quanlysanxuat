...
// Bản update của CreateInventoryReceiptGenericItemsSection.tsx — nội dung giống hệt, chỉ khác
...
export const UpdateInventoryReceiptGenericItemsSection = withForm({
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-1">
                              <Tooltip>
                                ...
                                />
                                <TooltipContent>{`Sửa dòng ${index + 1}`}</TooltipContent>
                              </Tooltip>
                              <Tooltip>
                                <TooltipTrigger
                                  render={
                                ...
                                />
                                <TooltipContent>{`Xóa dòng ${index + 1}`}</TooltipContent>
                              </Tooltip>
                            </div>
                          </TableCell>
                        </TableRow>
