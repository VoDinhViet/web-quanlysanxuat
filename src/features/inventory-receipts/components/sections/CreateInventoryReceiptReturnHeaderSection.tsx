...
// khác CreateInventoryReceiptHeaderSection.tsx ở combobox "Khách hàng cung cấp" thay cho các
...
export const CreateInventoryReceiptReturnHeaderSection = withForm({
      ...
      <div className="px-4 py-5 sm:px-5">
        ...
        <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* `requiresIqc` là boolean trong form state (không đổi sang chuỗi "no"/"yes" như
              CreateInventoryReceiptFromPoItemsSection.tsx's field.RadioPillField) — đổi type sẽ làm
              form mất khả năng tái dùng CreateInventoryReceiptGenericItemsSection bên dưới, vốn
