...
import { buildCreateInventoryReceiptReturnItemColumns } from "@/features/inventory-receipts/components/composites/CreateInventoryReceiptReturnItemsColumns"
...
export const CreateInventoryReceiptReturnItemsSection = withForm({
  ...
  render: function Render({ form, disabled }) {
    ...
    const columns = useMemo(
      () =>
        buildCreateInventoryReceiptReturnItemColumns({ itemsField, disabled }),
      [itemsField, disabled]
    )
