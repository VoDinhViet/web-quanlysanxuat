...
import { UpdateInventoryReceiptHeaderSection } from "@/features/inventory-receipts/components/sections/UpdateInventoryReceiptHeaderSection"
import { UpdateInventoryReceiptItemsSection } from "@/features/inventory-receipts/components/sections/UpdateInventoryReceiptItemsSection"
...
type UpdateInventoryReceiptFormProps = {
  inventoryReceipt: InventoryReceiptDetail
}
...
export function UpdateInventoryReceiptForm({
  inventoryReceipt,
}: UpdateInventoryReceiptFormProps) {
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-lg bg-card shadow-card">
        ...
        <UpdateInventoryReceiptHeaderSection
          form={form}
          disabled={isPending}
        ...
        <div className="border-t border-border">
          <UpdateInventoryReceiptItemsSection
            form={form}
            disabled={isPending}
          />
        </div>
