...
import { buildCreateInventoryReceiptReturnPickerColumns } from "@/features/inventory-receipts/components/composites/CreateInventoryReceiptReturnPickerColumns"
...
export const CreateInventoryReceiptReturnPickerSection = withForm({
  ...
  render: function Render({ form, disabled }) {
    ...
    const columns = useMemo(
      () =>
        buildCreateInventoryReceiptReturnPickerColumns({
          pickedIds,
          disabled,
          allChecked,
