...
// UpdateInventoryReceiptGenericItemsSection.tsx. Vẫn cố ý không hiển thị SL đã nhận trước đó/
// còn lại của từng dòng PO (giới hạn dữ liệu backend, xem file gốc).
export const UpdateInventoryReceiptPurchaseOrderItemsSection = withForm({
