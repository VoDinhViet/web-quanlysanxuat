...
// "DIRECT" nữa. Cùng khuôn use-get-item-options.ts của orders, khác ở chỗ itemOptionsQueryOptions
...
export function useGetInventoryReceiptItemOptions(type: "DIRECT" | "FG") {
