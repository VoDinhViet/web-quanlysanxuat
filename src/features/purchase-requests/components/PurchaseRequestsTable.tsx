...
import { PurchaseRequestsEmptyState } from "@/features/purchase-requests/components/PurchaseRequestsEmptyState"
...
export function PurchaseRequestsTable({
  ...
  return (
    ...
    >
      {/* `overflow-x-auto`, same reason as ProductionJobsTable.tsx: 8 columns overflow a
