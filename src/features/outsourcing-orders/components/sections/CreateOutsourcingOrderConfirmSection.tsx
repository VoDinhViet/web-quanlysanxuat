...
import { createOutsourcingOrderConfirmColumns } from "@/features/outsourcing-orders/components/composites/CreateOutsourcingOrderConfirmColumns"
import { sumOutsourcingOrderItemTotals } from "@/features/outsourcing-orders/constants/outsourcing-order-item-totals"
            ...
            >
              ...
              <TableBody>
                {table.getRowModel().rows.length === 0 ? (
                  <TableRow>
                    <TableCell
                      colSpan={createOutsourcingOrderConfirmColumns.length}
                    >
