...
type ConsumableQuantityCellVariant = "blue" | "orange" | "green" | "available"
...
// same cross-feature-isolation reason as ConsumableImageCell above.
export function ConsumableQuantityCell({
  value,
  variant,
}: {
  value: number
  variant: ConsumableQuantityCellVariant
}) {
