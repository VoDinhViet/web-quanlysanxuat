...
import { InventoryConsumablesTable } from "@/features/inventory-consumables/components/sections/InventoryConsumablesTable"
import { InventoryConsumablesTableFilter } from "@/features/inventory-consumables/components/sections/InventoryConsumablesTableFilter"
import { consumableInventoryQueryOptions } from "@/features/inventory-consumables/api/options"

export function InventoryConsumablesPage() {
  ...
  const search = useSearch({
    from: "/(authed)/manage_/inventory-consumables/",
  })

  const inventoryQuery = useQuery({
    ...consumableInventoryQueryOptions(search),
  ...
  return (
    <div className="flex w-full flex-col gap-4 p-4 sm:p-5 lg:p-6">
      <Surface contentClassName="min-h-[calc(100svh-13rem)]">
        <InventoryConsumablesTableFilter />
