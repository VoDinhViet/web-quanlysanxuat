...
import { updateConsumableFormDefaultValues } from "@/features/consumables/schemas/update-consumable.schema"
import { supplierOptionsQueryOptions } from "@/features/suppliers/api"
import { buildSelectOptions } from "@/lib/utils"

export const UpdateConsumableExtendedSection = withForm({
  defaultValues: updateConsumableFormDefaultValues,
  props: {
    disabled: false,
  },
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-5 px-4 py-5 sm:grid-cols-2 sm:px-5 lg:grid-cols-3">
          <form.AppField name="consumableGrade">
            {(field) => (
              <field.TextField
