...
import { exportConsumables } from "@/features/consumables/api/server-functions/export-consumables.api"
...
export function ConsumablesTableFilter() {
  const search = useSearch({ from: "/(authed)/manage_/consumables/" })
  const navigate = useNavigate({ from: "/manage/consumables/" })
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:flex-wrap lg:items-end lg:justify-between">
        <div className="grid flex-1 grid-cols-1 items-end gap-3 sm:grid-cols-2 lg:grid-cols-[minmax(15rem,1.6fr)_minmax(14rem,1.4fr)_minmax(9rem,1fr)]">
          ...
          <div className="space-y-1.5">
            <Label
              htmlFor="consumables-client"
              className="text-[11px] font-medium text-muted-foreground"
            >
              Khách hàng
            </Label>
            <ComboboxField
              id="consumables-client"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              <SelectTrigger id="consumables-status" className="w-full text-xs">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="flex w-full shrink-0 flex-wrap items-center justify-end gap-2 lg:ml-auto lg:w-auto lg:self-end">
          ...
          <RoutePermissionGate route="/manage/consumables/create">
            <LinkButton to="/manage/consumables/create" className="text-xs">
