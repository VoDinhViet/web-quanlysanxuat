...
export type ProductDetailTab = "info" | "boms" | "consumables"
...
export const productDetailTabSchema = z.enum(["info", "boms", "consumables"])
...
//
// `page`/`limit`/`q` back the "consumables" tab's list (GET .../bom/consumables) —
...
// consumables tab defaults them itself when reading `useSearch()`.
