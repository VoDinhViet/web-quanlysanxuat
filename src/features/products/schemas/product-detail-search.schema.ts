...
export type ProductDetailTab = "info" | "boms" | "directs"
...
export const productDetailTabSchema = z.enum(["info", "boms", "directs"])
...
//
// `page`/`limit`/`q` back the "directs" tab's list (GET .../bom/directs) —
...
// directs tab defaults them itself when reading `useSearch()`.
