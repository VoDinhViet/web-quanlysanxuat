...
export function ProductImageField({
  ...
  // xoá) sẽ 404 khi hiển thị lại — bắt qua `onError` để rơi về icon thay vì ảnh vỡ trần trụi,
  // cùng idiom QcEvidenceThumbnail.tsx. Reset ngay trong lúc render khi đổi ảnh (upload mới/xoá)
