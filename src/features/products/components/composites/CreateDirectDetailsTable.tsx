...
export type DirectDraftItem = {
  row: DirectPickerRow
  quantity: number | undefined
  note: string
}

type CreateDirectDetailsTableProps = {
  items: DirectDraftItem[]
  disabled: boolean
...
export function CreateDirectDetailsTable({
  items,
  disabled,
  onQuantityChange,
  onNoteChange,
  onRemove,
}: CreateDirectDetailsTableProps) {
  return (
