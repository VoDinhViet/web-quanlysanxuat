...
type ProductDocumentsFieldProps = {
...
// Tài liệu đính kèm cấp sản phẩm (hồ sơ kỹ thuật, tiêu chuẩn, catalogue...) — khác ảnh đại diện
// (ProductImageField) và khác bản vẽ theo từng node BOM (BomItemDrawingField).
export function ProductDocumentsField({
  value,
  onChange,
  disabled,
  className,
}: ProductDocumentsFieldProps) {
    ...
    <div className={cn("space-y-3", className)}>
      <div>
        ...
        <p className="text-[11px] text-muted-foreground">
          Bản vẽ, tiêu chuẩn kỹ thuật, tài liệu sản phẩm...
        </p>
      </div>
