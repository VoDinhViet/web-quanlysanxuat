...
export { departmentsQueryOptions } from "@/features/departments/api/options/departments.options"
export { departmentDetailQueryOptions } from "@/features/departments/api/options/department-detail.options"
