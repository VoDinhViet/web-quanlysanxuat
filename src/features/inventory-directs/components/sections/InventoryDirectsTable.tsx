...
import { inventoryDirectColumns } from "@/features/inventory-directs/components/composites/InventoryDirectsTableColumns"
...
type InventoryDirectsTableProps = {
  rows: DirectInventoryItem[]
...
function inventoryRowClassName(item: DirectInventoryItem): string | undefined {
...
export function InventoryDirectsTable({
  rows,
  pagination,
  isPending,
}: InventoryDirectsTableProps) {
  const table = useTable({
    data: rows,
    columns: inventoryDirectColumns,
