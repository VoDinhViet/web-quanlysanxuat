...
export function DirectImageCell({ item }: { item: DirectInventoryItem }) {
...
type DirectQuantityCellVariant = "blue" | "orange" | "green" | "available"
...
// same cross-feature-isolation reason as DirectImageCell above.
export function DirectQuantityCell({
  value,
  variant,
}: {
  value: number
  variant: DirectQuantityCellVariant
}) {
