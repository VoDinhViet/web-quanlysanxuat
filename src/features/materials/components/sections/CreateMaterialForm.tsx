...
import { createMaterial } from "@/features/materials/api/server-functions/create-material.api"
...
export function CreateMaterialForm() {
  ...
  const form = useAppForm({
    ...
    validators: {
      onDynamic: createMaterialSchema,
    },
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-lg bg-card shadow-card">
        ...
        <CreateMaterialExtendedSection form={form} disabled={isPending} />
