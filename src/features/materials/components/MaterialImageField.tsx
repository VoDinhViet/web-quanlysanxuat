...
import { uploadMaterialImage } from "@/features/materials/server-functions/upload-material-image"
...
export function MaterialImageField({
  ...
  const uploadImageFn = useServerFn(uploadMaterialImage)
  ...
  return (
    <div className="flex flex-col items-center gap-2 text-center">
      ...
      <div
        {...getRootProps({
          role: "button",
          "aria-label": "Tải hình ảnh vật tư lên",
          className: cn(
