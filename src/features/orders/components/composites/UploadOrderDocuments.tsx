...
export type UploadOrderDocumentsProps = {
  value: FileFieldValue[]
  // Chấp nhận cả updater function (không chỉ giá trị) — bắt buộc để tránh race khi thả nhiều
  // file liên tiếp: `field.handleChange` của TanStack Form vốn đã hỗ trợ dạng này (`Updater<TData>`).
  onChange: (
...
export function UploadOrderDocuments({
  ...
  return (
    <div className={cn("space-y-2.5", className)}>
      {/* Header đồng bộ phong cách UploadProductDocuments */}
      ...
      {/* Dropzone phong cách Linear / Vercel */}
      <div
        {...getRootProps({
          role: "button",
          "aria-label": "Tải tài liệu đính kèm đơn hàng lên",
          className: cn(
