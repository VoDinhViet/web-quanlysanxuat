...
// Nửa cuối bước ③ đã gộp (CreateOrderStepsTabs.tsx): 4 field tiền qua AppFormFields.tsx's kit +
// preview tổng tiền đọc trực tiếp từ form qua form.Subscribe. Render bởi
// CreateOrderConfirmSection.tsx.
export const CreateOrderTotalsSummary = withForm({
