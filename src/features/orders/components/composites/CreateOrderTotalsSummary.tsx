...
type CreateOrderTotalsSummaryProps = {
...
// useWatch. Render bởi CreateOrderConfirmSection.tsx.
export function CreateOrderTotalsSummary({
  form,
  disabled,
}: CreateOrderTotalsSummaryProps) {
