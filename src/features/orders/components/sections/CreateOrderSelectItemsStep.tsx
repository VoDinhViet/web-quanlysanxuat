...
// tick là ghi thẳng vào `items` field-array của form (pushValue/removeValue qua useField), không
// còn state "đang chọn tạm" riêng như bản popup cũ (OrderItemsPickerDialog.tsx, xem lịch sử). Bỏ
// tick 1 dòng đang có trong đơn tương đương xoá dòng đó khỏi đơn.
export const CreateOrderSelectItemsStep = withForm({
  ...
  render: function Render({ form }) {
    ...
    // idiom PurchaseRequestCreateDirectPickerSection.tsx.
