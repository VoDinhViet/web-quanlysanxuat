...
// Bước ① của wizard "Tạo đơn hàng". Giao diện được cấu trúc theo 4 phân vùng trực quan rõ ràng:
// 1. Khách hàng & Phụ trách kinh doanh
// 2. Kế hoạch & Địa chỉ giao hàng
// 3. Điều khoản thanh toán & Tiền tệ
// 4. Ghi chú & Lưu ý
      ...
      <div>
        ...
        <div className="divide-y divide-border/70">
          ...
          <OrderFormSection
            ...
            description="PO của khách, các mốc thời gian đặt/giao và địa điểm nhận hàng"
          >
