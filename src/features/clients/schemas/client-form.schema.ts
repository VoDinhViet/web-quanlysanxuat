...
// Raw form fields shared by the create and update client forms — used as the
// client-side `onSubmit` validator for both CreateClientForm and
// UpdateClientForm.
export const clientFormSchema = z
  .object({ ...clientProfileFields, contacts: clientContactsSchema })
  .superRefine(refineClientEmail)

export type ClientFormSchema = z.input<typeof clientFormSchema>
...
export type ClientContactInput = ClientFormSchema["contacts"][number]

export const CLIENT_FORM_DEFAULT_VALUES: ClientFormSchema = {
  name: "",
  clientGroupId: "",
  taxCode: "",
  phoneNumber: "",
