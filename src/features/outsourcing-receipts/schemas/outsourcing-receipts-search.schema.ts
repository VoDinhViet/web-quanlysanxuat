...
// `q` (not `directKeyword` — BE has no such param) matches `outsourcingReceipts.code` only, not
// direct name/code. `status` narrowed to POSTED/CANCELLED literals — BE's own
