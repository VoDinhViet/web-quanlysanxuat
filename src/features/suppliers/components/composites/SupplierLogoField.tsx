...
export function SupplierLogoField({
  ...
  // File đã upload nhưng bị dọn (orphan sweep sau 24h nếu không gắn vào NCC nào, hoặc bị xoá) sẽ
  // 404 khi hiển thị lại — bắt qua `onError` để rơi về icon thay vì ảnh vỡ trần trụi, cùng idiom
  // QcEvidenceThumbnail.tsx. Reset ngay trong lúc render khi đổi ảnh (upload mới/xoá) — "adjusting
  // state when a prop changes" theo khuyến nghị của React, không dùng effect vì compiler chặn
