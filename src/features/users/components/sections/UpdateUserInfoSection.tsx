...
type UpdateUserInfoSectionProps = {
  form: UseFormReturn<UpdateUserSchema>
  disabled: boolean
}

// Each field is a plain <Controller> render-prop, same idiom as CreateUserInfoSection.tsx — no
// shared RHF field kit (see forms-and-ui.md).
export function UpdateUserInfoSection({
  form,
  disabled,
}: UpdateUserInfoSectionProps) {
  return (
    <div>
