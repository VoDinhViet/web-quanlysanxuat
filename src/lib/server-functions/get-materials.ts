...
// why (route-facing `materialsSearchSchema` stays local to the materials
// route, this one just needs to be wire-valid for the backend). The products
// feature's BOM material picker is the other caller, fixing `status: ACTIVE`
// and driving `q` from the picker's search box.
