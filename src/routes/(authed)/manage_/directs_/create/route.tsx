...
// Layout route for /manage/directs/create — renders the real header
...
// mirrors.
export const Route = createFileRoute("/(authed)/manage_/directs_/create")({
  component: CreateDirectLayout,
})

function CreateDirectLayout() {
  return (
