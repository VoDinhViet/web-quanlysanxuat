// Curated design-sync bundle entry — every shadcn ui/ primitive plus the
// pure shared components. App-coupled shared components (PageTitleBar,
// AppSidebar, TablePagination, AppFormFields, ThemeProvider) are deliberately
// excluded: they import server functions or require router/form context.
...
export * from "../src/components/shared/IconButton"
export * from "../src/components/shared/DatePickerField"
